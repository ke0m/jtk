...
def goTensors():
    ...
    for i,read in enumerate(reads):
        ...
        plot("",g,s1,s2,d04,dscale=1,png=pref+"04_square_cb")
...
pngDir = "." # where to put PNG images of plots
...
def plotPnz(title,g,s1,s2,d=None,dscale=1,cmin=0,cmax=0,png=None):
    ...
    pp.setHLabel("Inline (km)")
    pp.setVLabel("Crossline (km)")
    pp.setHInterval(2.0)
    pp.setVInterval(2.0)
